...
activities = {
    ...
    "Basketball Team": {
        "description": "Competitive basketball team for interschool matches",
    ...
    "Art Studio": {
        "description": "Painting, drawing, and visual arts workshops",
        "schedule": "Tuesdays, 3:30 PM - 5:00 PM",
        "max_participants": 18,
        "participants": ["grace@mergington.edu", "henry@mergington.edu"]
    },
    "Science Olympiad": {
        "description": "Competitive science competitions and experiments",
